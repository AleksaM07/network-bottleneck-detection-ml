...
def preprocess_inputs(df):
    ...
    X = data_frame.drop('Anomaly', axis=1)
    y = data_frame['Anomaly']
...
if __name__ == '__main__':
    ...
    df = pd.read_excel('test2.xlsx', sheet_name='Aggregated sheets').fillna(0).drop_duplicates()
    ...
    print(non_numeric_and_time_cols)
